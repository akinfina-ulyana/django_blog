...
class Post(models.Model):
    ...
    slug = models.SlugField(max_length=250, unique_for_date='publish') # уникальное по полю publish
    ...
    def get_absolute_url(self):
        return reverse('blog:post_detail', args=[self.publish.year,
                                                          ...
                                                          self.publish.day,
                                                          self.slug])
    # reverse() будет формировать URL-адрес динамически. У меня именное пространство blog и url для post_detail
